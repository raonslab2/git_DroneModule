...
async def print_serversend(droneInfo,drone,conn,curs):
    ...
    while running:  
        sql = "INSERT INTO br_drone_state"+ \
            "(dl_id, st_status, st_satelite_num, st_bat_voltage, st_bat_level, st_speed, st_x, st_y, st_z, st_atitude,st_roll,st_pitch,st_yaw,st_head,st_state,st_mode)" + \
            "VALUES('" + tmName + "', " + \
            "1," + \
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        ...
        #host = "ws://34.64.113.170:5010/websocket"
